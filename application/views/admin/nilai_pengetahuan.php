...
<?php endif; ?>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <center><h4 class="card-title">Nilai Pengetahuan</h4></center>
						                  ...
						                  <?php
						                     ...
						                     foreach ($siswa as $dat) : ?>
						                      ...
						                      <tr>
						                           ...
						                           <td>
						                              <a href="<?= base_url('admin/nilai_pengetahuan/detail_pengetahuan/') . $dat['nisn'] ?>" class="btn btn-primary">Detail</a>
      ...
      <div class="modal-dialog">
         <div class="modal-content">
            <div class="modal-header">
               <h5 class="modal-title" id="exampleModalLabel">input nilai pengetahuan</h5>
               <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
               </button>
            </div>
            <div class="modal-body">
               <form action="<?= base_url('admin/nilai_pengetahuan/input_nilai') ?>" method="POST">
